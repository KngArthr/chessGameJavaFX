...
//
//Description:
//This class is for the Pawn chess piece, it is meant to make sure the move done is a legal one
...
public class Pawn extends Figure {
	...
	//Constructor
	public Pawn(String team, boolean isAlive, ImageView imageView) {
